...
public class Move {
    ...
    public static void checkMove(LifesInGame lifes) {
        ...
        if (lifes instanceof Ballom  && lifes.getCountStep() > 0) {
    ...
    public static void Down(LifesInGame lifes) {
        if (lifes.getY() % 16 == 0 && lifes.getX() % 4 == 0) {
            ...
            if (lifes instanceof Ballom && Collision.canMove(lifes.getX() - 1, lifes.getY())) {
                lifes.setDirect("down");
                lifes.setCountStep(4/speed);
                checkMove(lifes);
            }
    ...
    public static void Up(LifesInGame lifes) {
        if (lifes.getY() % 32 == 0 && lifes.getX() % 32 == 0) {
            if (lifes instanceof Bomber && Collision.canMove(lifes.getX(), lifes.getY() - 1)) {
                lifes.setDirect("up");
                lifes.setCountStep(4 / speed);
                checkMove(lifes);
